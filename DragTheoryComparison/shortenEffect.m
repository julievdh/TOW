...
% entangled efficiency = 0.13 -- 0.13 after edits July 24
% nonentangled efficiency = 0.13 -- 0.13 after edits July 24
Pe = (Dtot*1.23)./0.13;
...
for i = 1:10
    daysmin(i) = min(find(Wa(i,:) > 8.57E9));
    daysmin_short(i) = min(find(Wa_short(i,:) > 8.57E9));
end
...
text(-0.4,935,'D','FontWeight','Bold','FontSize',18)
