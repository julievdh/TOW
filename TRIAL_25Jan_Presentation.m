...
load('20120912_J120604')

% convert tow (kg) to tow (N)
tow(:,2) = tow(:,2)*9.86;
...
plot(TDRtime,-TDRdepth*10,'color',[204/255 83/255 20/255],'linewidth',2)
plot(towtime,tow(:,2),'b','linewidth',2)
...
%% Find 30 s with min variability within each bin
